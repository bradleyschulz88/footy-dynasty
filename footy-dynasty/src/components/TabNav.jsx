...
export default function TabNav({
  ...
  return (
    <div
      className="flex gap-1 p-1 rounded-xl mb-5 overflow-x-auto no-scrollbar scroll-smooth snap-x"
      ...
      {tabs.map((tb) => {
        ...
        return (
          <button
            ...
            style={isActive
              ? { background: "var(--A-accent)", color: "var(--fd-on-accent, #0A0D0C)", boxShadow: "0 2px 8px color-mix(in srgb, var(--A-accent) 25%, transparent)" }
